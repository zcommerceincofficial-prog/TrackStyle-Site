...
function Nav() {
  ...
  return React.createElement(React.Fragment, null, React.createElement('nav', {
    ...
    href: 'index.html',
    className: 'nav-logo',
    'aria-label': 'TrackStyle'
  }, React.createElement('img', { src: 'assets/logo-transparent.png', alt: '', className: 'brand-logo-img' }), React.createElement('span', { className: 'sr-only' }, 'TrackStyle')), React.createElement('ul', {
    className: 'nav-links'
  ...
  }, 'Home'), SERVICES_NAV.map(function (s) {
    return React.createElement('a', {
      key: s.href,
      href: s.href,
      onClick: function () {
...
function Footer() {
  ...
  }, React.createElement('img', { src: 'assets/logo-transparent.png', alt: '', className: 'brand-logo-img footer-logo-img' }), React.createElement('span', { className: 'sr-only' }, 'TrackStyle')), React.createElement('p', {
    className: 'footer-tagline'
  }, 'Premium automotive styling and protection in Phoenix, AZ. Built by enthusiasts, for enthusiasts.')),
  // Services col
  React.createElement('div', null, React.createElement('span', {
    className: 'footer-col-title'
  }, 'Services'), React.createElement('ul', {
  ...
  React.createElement('div', null, React.createElement('span', {
    ...
    className: 'footer-contact-val'
  }, '10201 N 21st Ave Suite 9', React.createElement('br', null), 'Phoenix, Arizona')))), React.createElement('div', {
    className: 'footer-bottom'
  }, React.createElement('span', {
    className: 'footer-copy'
  }, '© ' + year + ' TrackStyle. All rights reserved.'), React.createElement('div', {
    className: 'footer-social'
  }, React.createElement('a', {
    href: 'https://instagram.com/trackstyles',
    target: '_blank',
...
function ServicePageLayout(props) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Nav, null), React.createElement('section', {
  ...
  }, eyebrow || 'TrackStyle · Phoenix, AZ'), React.createElement('h1', null, title), React.createElement('p', {
    className: 'hero-sub'
  }, subtitle))), image && React.createElement('section', {
    ...
    className: 'section-label'
  }, 'Overview'), description.map(function (para, i) {
    ...
    className: 'section-label'
  }, optionsTitle || 'Options'), React.createElement('h2', null, 'What We Offer'), React.createElement('div', {
    className: 'options-grid'
  }, options.map(function (opt, i) {
    return React.createElement('div', {
      key: i,
      className: 'option-card'
    }, React.createElement('h4', null, opt.name), React.createElement('p', null, opt.desc));
  })))), React.createElement('section', {
  ...
  }, React.createElement('h2', null, 'Ready to Get Started?'), React.createElement('a', {
    href: 'contact.html',
    className: 'btn btn-dark'
  }, 'Get in Touch')))), React.createElement(Footer, null));
}
window.Nav = Nav;
